...
public class PaperCommandBuilder extends CommandBuilder<PaperCommand, CommandSender, Entity, PaperContext, PaperPreContext, PaperFormat> {
    @Override
    protected PaperCommand create(String identifier) {
        return new PaperCommand(identifier);
    }

    @Override
    protected PaperCommand create(String identifier, String description, String... aliases) {
