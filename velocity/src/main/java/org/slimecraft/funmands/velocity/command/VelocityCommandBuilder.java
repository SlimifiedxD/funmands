...
public class VelocityCommandBuilder extends CommandBuilder<VelocityCommand, CommandSource, CommandSource, VelocityContext, VelocityPreContext, VelocityFormat> {
    @Override
    protected VelocityCommand create(String identifier) {
        return new VelocityCommand(identifier);
    }

    @Override
    protected VelocityCommand create(String identifier, String description, String... aliases) {
